...
const Logo = () => (
  <div className="flex flex-row items-center justify-center w-full h-20">
    <NavLink
      className="w-10 h-10 transition-all duration-200 ease-in rounded-full focus:bg-teal-800 hover:bg-teal-800 focus:outline-none focus:shadow-outline"
      to="/"
    >
...
const Nav = () => {
  ...
  return (
    <nav className="relative flex-grow block">
      <span
        className="absolute w-full h-10 transition-transform duration-200 ease-out bg-white rounded-lg shadow"
        style={{ transform: `translateY(calc(100% * ${selected}))` }}
      />
      <div className="relative flex flex-col items-center">
        <NavLink
          to={links[0]}
          className="flex items-center justify-center w-full px-3 py-2 rounded-lg focus:outline-none focus:shadow-outline"
          onClick={() => setSelected(0)}
        >
          <svg
            className={`w-6 h-6 transition-all ease-out ${
              selected === 0 ? 'text-teal-900' : 'text-white'
            }`}
            viewBox="0 0 24 24"
            fill="currentColor"
          >
        ...
        >
          <svg
            className={`w-6 h-6 transition-all ease-out ${
              selected === 1 ? 'text-teal-900' : 'text-white'
            }`}
            viewBox="0 0 24 24"
            fill="currentColor"
          >
        ...
        >
          <svg
            className={`w-6 h-6 transition-all ease-out ${
              selected === 2 ? 'text-teal-900' : 'text-white'
            }`}
            viewBox="0 0 24 24"
            fill="currentColor"
          >
        ...
        >
          <svg
            className={`w-6 h-6 transition-all ease-out ${
              selected === 3 ? 'text-teal-900' : 'text-white'
            }`}
            viewBox="0 0 24 24"
            fill="currentColor"
          >
        ...
        >
          <svg
            className={`w-6 h-6 transition-all ease-out ${
              selected === 4 ? 'text-teal-900' : 'text-white'
            }`}
            viewBox="0 0 24 24"
            fill="currentColor"
          >
...
const Parameters = () => (
  <div className="w-full">
    <div className="flex flex-col items-center justify-between">
      <hr className="w-10 mb-5 border-teal-800" />
      <div className="flex flex-row items-center justify-center pb-3">
        <button
          type="button"
          className="w-10 h-10 transition-all duration-200 ease-in rounded-full hover:bg-teal-800 focus:bg-teal-800 focus:outline-none focus:shadow-outline"
        >
          <FontAwesomeIcon className="text-xl text-white" icon="yen-sign" />
        </button>
      </div>
      <div className="flex flex-row items-center justify-center">
        <button
          ...
          className="w-10 h-10 transition-all duration-200 ease-in rounded-full hover:bg-teal-800 focus:bg-teal-800 focus:outline-none focus:shadow-outline"
        >
          <FontAwesomeIcon className="text-xl text-white" icon="globe" />
        </button>
      </div>
      <hr className="w-10 mt-5 border-teal-800" />
      <div className="flex flex-row items-center justify-center h-20">
        <button
          type="button"
          className="w-10 h-10 transition-all duration-200 ease-in rounded-full hover:bg-teal-800 focus:outline-none focus:shadow-outline"
        >
